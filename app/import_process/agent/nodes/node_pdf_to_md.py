...
#     # 可以放 N 个 PDF
#     test_pdf_names = [
#         os.path.join("doc", "hak180产品安全手册.pdf"),
#         os.path.join("doc", "LJ2680DN用户手册.pdf"),
#     ]
#     # ==========================================================
#
#     # 循环批量处理
#     for idx, test_pdf_name in enumerate(test_pdf_names, 1):
#         logger.info(f"\n===== 处理第 {idx} 个 PDF =====")
#
#         test_pdf_path = os.path.join(PROJECT_ROOT, test_pdf_name)
#         logger.info(f"当前测试PDF：{test_pdf_path}")
#
#         # 构造测试状态
#         test_state = create_default_state(
#             task_id=f"test_pdf2md_task_00{idx}",  # 每个文件任务ID不同
